                    ...
                    <Card>
                        ...
                        <InvoiceTable :key="additionkey">
                            ...
                            <template #Body>
                                ...
                                <TableRow>
                                    <TableBodyHeader>
                                        <button @click="addAddition">{{ __('Add Addition') }}</button>
                                    </TableBodyHeader>
                                    <TableBody colspan="3"></TableBody>
                                    <TableBody>{{ total_additions }}</TableBody>
                                </TableRow>
                            </template>
                        </InvoiceTable>
                        <!-- <InvoiceTable>
                    ...
                    <Card>
                        ...
                        <InvoiceTable>
                            ...
                            <template #Body>
                                ...
                                <TableRow>
                                    <TableBodyHeader>
                                        <button @click="addDeduction">{{ __('Add Deduction') }}</button>
                                    </TableBodyHeader>
                                    <TableBody colspan="3"></TableBody>
                                    <TableBody>{{ total_deductions }}</TableBody>
                                </TableRow>
                            </template>
                        </InvoiceTable>
                        <!-- <InvoiceTable>
